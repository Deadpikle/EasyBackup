...
namespace Monitor.Core.Utilities
{
    ...
    /// There is no license on the code project site listed, so we'll assume that it is OK to use given
    /// that the article says, "I hope you find it of value in your own projects." and his lack of
    /// response on a license.
    /// TODO: update to use https://learn.microsoft.com/en-us/dotnet/api/system.io.filesysteminfo.linktarget?view=net-7.0
    /// https://stackoverflow.com/a/74024819
    /// in Avalonia/.NET 6+ version
    /// </summary>
